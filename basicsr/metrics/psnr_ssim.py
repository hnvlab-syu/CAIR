...
def calculate_psnr_left(
    img1, img2, crop_border, input_order="HWC", test_y_channel=False
):
...
def calculate_ssim(
    img1, img2, crop_border, input_order="HWC", test_y_channel=False, ssim3d=True
):
    ...
    def _cal_ssim(img1, img2):
        ...
        with torch.no_grad():
            final_ssim = (
                _ssim_3d(img1, img2, max_value)
                if ssim3d
                else _ssim(img1, img2, max_value)
            )
